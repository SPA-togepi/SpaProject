...
//            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
     ...
     * A placeholder fragment containing a simple view.
     */
    public static class AdminPlaceholderFragment extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
        ...
        public AdminPlaceholderFragment() {
        }
         ...
         * number.
         */
        public static AdminPlaceholderFragment newInstance(int sectionNumber) {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position) {
                ...
                case 1:
                    return AdminPlaceholderFragment.newInstance(position);
